...
_Side note: The OLAT forum does provide a solution for the `UnicodeDecodeError` which I attempted but after restarting the VM instance, I received the `NVIDIA driver on your system is too old` error._
